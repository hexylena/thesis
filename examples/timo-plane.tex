...
\fancyhead[CO,CE]{\ifdraft{DRAFT:\texttt{\gitRev}}{}}
\fancyfoot[CO,CE]{\ifdraft{DRAFT:\texttt{\gitRev}}{}}
...
\include{chapters/intro-annotation}
	% \include{chapters/phages}
	% \include{chapters/circos}

\include{chapters/intro-cancer}
	% \include{chapters/ecpc}
	% \include{chapters/htsget}

\include{chapters/intro-training}
