...
\fancyhf{}
\input{vars}
\fancyhead[LE]{@hexylena}
\fancyhead[RO]{bioinformagic}
...
\include{chapters/platform/intro}
	...
	\include{chapters/platform/planemo}
...
\include{chapters/annotation/intro}
	...
	%\include{chapters/annotation/gga} - WRITE

% \interstitial{cancer}
\include{chapters/cancer/intro}
	\include{chapters/cancer/circos}
	\include{chapters/cancer/htsget}
	%\include{chapters/cancer/cancergalaxy} - DROP?
	%\include{chapters/cancer/EC-PC} - MUST
	%\include{chapters/cancer/pathways}% MAYBE

% \interstitial{training}
