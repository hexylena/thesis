...
\begin{figure}[t!]
\centering
\includegraphics[height=10em]{chapters/platform/tiaas.png}
\end{figure}
\vspace{-4cm}

\begin{changemargin}{0cm}{2cm}
\articletitle{Training Infrastructure as a Service (DRAFT)}
\end{changemargin}
...
\textbf{Published in:} \emph{GigaScience}, Volume XX, Issue YY, January 2023, ,  \\
...
\begin{figure}[bt!]
\centering
	\includegraphics[width=\linewidth]{chapters/images/tiaas/event-starts.png}
	\includegraphics[width=\linewidth]{chapters/images/tiaas/event-lengths.png}
	\includegraphics[width=\linewidth]{chapters/images/tiaas/event-sizes.png}
