...
A similar pattern of upregulation is seen in endothelial cells when exposed to the TNF-conditioned pericyte medium. The pattern of expression changes in CCL genes match those of the first condition, when endothelial cells were exposed directly to TNF (\cref{fig:foldchange3}).
