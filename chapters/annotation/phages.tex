...
\begin{figure}[t!]
\centering
\includegraphics[height=10em]{chapters/platform/phages.png}
\end{figure}
\vspace{-4cm}
...
while phage regularly contain group I introns \cite{Lambda,Candales_2011,Leclercq_2012}. In the case
