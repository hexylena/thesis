...
\phantomsection\addcontentsline{toc}{section}{Apollo: Democratizing genome annotation}

\begin{figure}[t!]
\centering
\includegraphics[height=10em]{chapters/annotation/apollo.png}
\end{figure}
\vspace{-4cm}

\begin{changemargin}{0cm}{2cm}
\articletitle{Apollo: Democratizing genome annotation}
\end{changemargin}

% Helena Rasche\textsuperscript{\ref{phage-affil:1},\ref{phage-affil:2}§},
Nathan~A.~Dunn\textsuperscript{\ref{phage-affil:1}},
Deepak~R.~Unni\textsuperscript{\ref{phage-affil:1}},
Colin~Diesh\textsuperscript{\ref{phage-affil:2}},
Monica~Munoz-Torres\textsuperscript{\ref{phage-affil:3}},
Nomi~L.~Harris\textsuperscript{\ref{phage-affil:1}},
Eric~Yao\textsuperscript{\ref{phage-affil:2}},
Helena~Rasche\textsuperscript{\ref{phage-affil:4}},
Ian~H.~Holmes\textsuperscript{\ref{phage-affil:2}},
Christine~G.~Elsik\textsuperscript{\ref{phage-affil:5}},
Suzanna~E.~Lewis\textsuperscript{\ref{phage-affil:1}}

\textbf{Published in:} \emph{PLOS Computational Biology}, February 6, 2019 \\
...
\begin{enumerate}
\itemsep-0.5em
\item Environmental Genomics and Systems Biology, Lawrence Berkeley National Laboratory, Berkeley, California, United States of America.\label{apollo-affil:1}
\item Deptartment of Bioengineering, University of California, Berkeley, California, United States of America.\label{apollo-affil:2}
\item Translational and Integrative Sciences Lab, Oregon State University, Corvallis, Oregon, United States of America.\label{apollo-affil:3}
\item Bioinformatics Group, University of Freiburg, Freiburg, Germany.\label{apollo-affil:4}
\item Animal Sciences Division, University of Missouri, Columbia, Missouri, United States of America.\label{apollo-affil:5}
\end{enumerate}
...
\cite{Lewis_2002}. As software technologies advanced, each new generation of
...
running inside a web browser \cite{Lee_2013}. Once Apollo became a web-based
...
species. Our most recent version of Apollo \cite{zenodo.1295754} offers a broad range
of researchers an accessible way to improve the biological precision of
their genomic feature descriptions.

Organizations that use Apollo include Echinobase \cite{Kudtarkar_2017}, Hymenoptera
Genome Database \cite{Elsik_2015}, i5k Workspace \cite{Poelchau_2014}, PhytoPath \cite{Pedro_2015},
TreeGenes \cite{Neale_2014}, Vectorbase \cite{Giraldo_Calder_n_2014} and XenBase \cite{James_Zorn_2015}. To date, the
i5K Workspace has supported publication of seven insect genomes that
were manually curated with Apollo \cite{Poynton_2018,McKenna_2016,Linnen_2018,Schoville_2018,Papanicolaou_2016,Kanost_2016,Benoit_2016}. Other projects that have
used Apollo include genomes of additional insects \cite{Fu_2018,Gouin_2017,Chen_2015}, human
parasites \cite{Zhu_2017,Ifeonu_2016,Ifeonu_2016_2}, birds \cite{Colquitt_2018,Lee_2018}, the sea lamprey \cite{Smith_2018},
plants \cite{Pilkington_2018,Li_2017,Xu_2016}, fungi \cite{Chen_2016,Frantzeskakis_2018,Jelen_2016,Nemri_2014,Schuelke_2016,Syme_2016} and a plant pathogenic nematode
\cite{Eves_van_den_Akker_2016}. Projects such as the re-annotation of the whipworm genome by
hundreds of high school students in the UK, supported by the Institute
for Research in Schools (IRIS) \cite{GenomeDecodersHumanWhipworm}, and the curation of 33,044 gene
...
genes of a fungal mitochondrial genome \cite{Jelen_2016}. Other reported Apollo
...
pheasant \cite{Lee_2018} and the effector complement of the flax rust pathogen
Melampsora lini \cite{Nemri_2014}. Through the process of gene model curation,
...
automated gene predictions \cite{Eves_van_den_Akker_2016}.
...
\centering
	\includegraphics[width=\textwidth]{chapters/images/apollo/1.png}
...
\centering
	\includegraphics[width=\textwidth]{chapters/images/apollo/2.png}
...
Apollo's client interface is built as a JBrowse \cite{Buels_2016} plugin, a
...
The server is built using Grails \cite{Smith2014}, an open source framework for
developing web applications using Groovy \cite{ApacheGroovyProgrammingLanguage} and other JVM
...
\centering
	\includegraphics[width=\textwidth]{chapters/images/apollo/3.png}
...
\centering
	\includegraphics[width=\textwidth]{chapters/images/apollo/4.png}
...
\cite{Afgan_2018} via the G-OnRamp project \cite{GOnRamp}, GenSAS \cite{Lee_2011,Humann2018}, DNA
Subway \cite{Hilgert_2014}, and the i5K workspace \cite{Poelchau_2014}. The i5K project
leverages the user registration services, and the Galaxy Genome
Annotation (GGA) project \cite{Bretaudeau2018} automatically generates new projects
...
\cite{Rasche2017} and is used by projects such as BioInformatics Platform for
Agroecosystem Arthropods (BIPAA) \cite{Bretaudeau2017} and Texas A\&M University
Center for Phage Technology (TAMU-CPT) \cite{Rasche2018}.
...
BigWig, or the Chado database \cite{Mungall_2007} are supported. These
...
Phenotype Ontology \cite{K_hler_2016} the Mouse Genome Database \cite{Smith_2017} and
Wormbase \cite{Lee_2017}, we expanded the Apollo web services to serve pieces
...
\cite{McMurry_2016} and the Alliance of Genome Resources (AGR) \cite{AllianceGenomeResources} in some of
...
\centering
	\includegraphics[width=\textwidth]{chapters/images/apollo/5.png}
...
\item
  ...
  implementation \cite{zenodo.1296537}. Additionally, after every Apollo release, an
...
to Chado \cite{Mungall_2007} and thus require multiple joins in order to retrieve
...
Genome Institute project to sequence every vertebrate genome \cite{Pennisi_2018}
...
stably supported central resource \cite{Gibney_2013}. To overcome this,
