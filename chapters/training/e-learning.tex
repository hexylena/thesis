...
\phantomsection\addcontentsline{toc}{section}{Fostering accessible online education using Galaxy as an e-learning platform}

\begin{figure}[t!]
\centering
\includegraphics[height=10em]{chapters/platform/e-learning.png}
\end{figure}
\vspace{-4cm}
