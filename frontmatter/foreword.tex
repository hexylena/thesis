...
\vspace{-1cm}
The big book of spells, pick one out, cast it, and voila, your \emph{Nature} paper ready to go.

Of course this is a dream, there's no magic in science, just a long slow slog.
...
\begin{center}
\includegraphics[scale=0.25]{chapters/images/foreword.png}
\end{center}
